...
#define COMPILER_ID_UNKNOWN 0
#define COMPILER_ID_GCC 1
#define COMPILER_ID_CLANG 2
#define COMPILER_ID_MSVC 3

// define USED_COMPILER macro
#if defined(__clang__)
	#define USED_COMPILER COMPILER_CLANG
#elif defined(__GNUC__) || defined(__GNUG__)
	#define USED_COMPILER COMPILER_ID_GCC
#elif defined(_MSC_VER)
	#define USED_COMPILER USED_COMPILER_MSVC
#else
	// Other compilers
	#define USED_COMPILER USED_COMPILER_UNKNOWN
#endif
...
#if USED_COMPILER == COMPILER_ID_CLANG
	#define ASSUME(cond) __builtin_assume((cond))
#elif USED_COMPILER == COMPILER_ID_GCC
	#define ASSUME(cond) __builtin_expect((cond), 1)
#elif USED_COMPILER == COMPILER_ID_MSVC
